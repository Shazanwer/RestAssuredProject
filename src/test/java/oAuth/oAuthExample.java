...
public class oAuthExample {
	...
	public void test1() {
		...
		Response response = RestAssured.given().baseUri("http://100.26.23.64:8088").auth().preemptive()
		...
		response = RestAssured.given().baseUri("http://100.26.23.64:8088")
				.auth().oauth2(token).when().get("/students/2");
